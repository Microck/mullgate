...
export async function startFixtureServer(): Promise<FixtureServer> {
  ...
  const relayFixture = await readFile(path.join(fixtureDir, 'app-relays.json'), 'utf8');
...
export function buildHealthyDockerFixtures(): readonly DockerContainerFixture[] {
  return [
    ...
    {
      Name: 'mullgate-wireproxy-sweden-gothenburg-1',
      Service: 'wireproxy-sweden-gothenburg',
      Project: 'mullgate',
      State: 'running',
      Health: 'healthy',
      Status: 'Up 40 seconds',
    ...
    {
      Name: 'mullgate-wireproxy-austria-vienna-1',
      Service: 'wireproxy-austria-vienna',
      Project: 'mullgate',
      State: 'running',
      Health: 'healthy',
      Status: 'Up 40 seconds',
