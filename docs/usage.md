...
### Required for the default non-interactive run
...
Set `MULLGATE_EXIT_SOURCE=tailscale-exit` when you want one Tailscale sidecar pinned to a Mullvad exit instead of the default Mullvad WireGuard entry device.
